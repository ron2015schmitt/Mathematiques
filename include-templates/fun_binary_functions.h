...
// (1) MultiArray<E1(D1)> ##OP## MultiArray<E2(D2)>
...
auto ##FUNCTION##(const MArrayExpR<A, E1, D1, Depth, R>& x1, const MArrayExpR<B, E2, D2, Depth, R>& x2) {
...
template <class A, class B, class E1, class E2, class D1, class D2, int M1, int M2, int R1, int R2,
  ...
  return  TER_Binary<MArrayExpR<A, E1, D1, M1, R1>,
    ...
    FUNCTOR_##NAME##<Element, Element, E3, D1, D2, D3> >(x1, x2);
}
...
// (4A) MultiArray<D1,R,Depth> ##OP## MultiArray<D2,R,1>
...
template <class A, class B, class E1, class D1, class D2, int M1, int M2, int R,
  ...
  auto ##FUNCTION##(const MArrayExpR<A, E1, D1, M1, R>& x1, const MArrayExpR<B, D2, D2, M2, R>& x2) {
...
// (4B) MultiArray<D1,R,1> ##OP## MultiArray<D2,R,Depth>
...
template <class A, class B, class E2, class D1, class D2, int M1, int M2, int R,
  ...
  auto ##FUNCTION##(const MArrayExpR<A, D1, D1, M1, R>& x1, const MArrayExpR<B, E2, D2, M2, R>& x2) {
  // NOT SURE WHICH OF THE THREE IS BEST
