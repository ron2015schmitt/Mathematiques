...
// (2A) MultiArray<E(D1)> ##OP## D2

template <class A, class D2, class E, class D1, int M, int R, typename = std::enable_if_t<NumberTrait<D2>::value>>
auto ##FUNCTION##(const MArrayExpR<A, E, D1, M, R>& x1, const D2& x2) {
  typedef typename ##TYPECLASS##<D1, D2>::Type D3;
  typedef typename NumberTrait<E, D3>::ReplaceTypeD E3;
