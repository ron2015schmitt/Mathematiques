...
auto ##FUNCTION##(const MArrayExpR<A, E1, D1, M, R>& x1, const MArrayExpR<B, E2, D2, M, R>& x2) {
...
auto ##FUNCTION##(const MArrayExpR<A, Element, D1, M, R>& x1, const D2& x2) {
  typedef typename ##TYPECLASS##<D1, D2>::Type D3;
...
auto ##FUNCTION##(const D1& x1, const MArrayExpR<B, Element, D2, M, R>& x2) {
  typedef typename ##TYPECLASS##<D1, D2>::Type D3;
  typedef typename NumberTrait<Element, D3>::ReplaceTypeD E3;
...
// (4A) MultiArray<D1,R,M> ##OP## MultiArray<D2,R,1>
...
// (4B) MultiArray<D1,R,1> ##OP## MultiArray<D2,R,M>
