...
template <class E1, class E2, class E3, class E4, class NT1, class NT2, class NT3, class NT4> class FUNCTOR___NAME__ {
public:
  static NT4 apply(const NT1 d1, const NT2 d2, const NT3 d3) {
    return __FUNCTION__(d1, d2, d3);
  }
