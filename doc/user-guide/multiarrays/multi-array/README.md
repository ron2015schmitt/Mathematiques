...
8.3. _Container Types (Vector, Matrix & MultiArray)_ <br>
...
# [8.3. Container Types (Vector, Matrix & MultiArray)](../README.md)<br>
8.3.1. [Vector](../vector/README.md)<br>
8.3.2. [Matrix](../matrix/README.md)<br>
8.3.3. _MultiArray_ <br>
