...
int main() {
  ...
  OUTPUT("| :--- | :---: | :---: | :---:  | :---:  | :---:  | :---:  | :---:  | :---: | :---: |");
  OUT("| float | Single Precision | ");
  OUT(CHAR_BIT*sizeof(float));
  OUT(" | [IEEE 754-2008 binary32](https://en.wikipedia.org/wiki/Single-precision_floating-point_format) |");
  OUT(numeric_limits<float>::digits10);
  OUT(" | ");
  OUT(numeric_limits<float>::max_digits10);
  OUT(" | ");
  OUT(numeric_limits<float>::epsilon());
  OUT(" | ");
  OUT(numeric_limits<float>::min());
  OUT(" | ");
  OUT(numeric_limits<float>::lowest());
  OUT(" | ");
  ...
  OUT(CHAR_BIT*sizeof(double));
  OUT(" | [IEEE 754-2008 binary32](https://en.wikipedia.org/wiki/Single-precision_floating-point_format) |");
  OUT(numeric_limits<double>::digits10);
  OUT(" | ");
  OUT(numeric_limits<double>::max_digits10);
  OUT(" | ");
  OUT(numeric_limits<double>::epsilon());
  OUT(" | ");
  OUT(numeric_limits<double>::min());
  OUT(" | ");
  OUT(numeric_limits<double>::lowest());
  OUT(" | ");
  ...
  OUT("| long double | Quad Precision | ");
  OUT(CHAR_BIT*sizeof(long double));
  OUT(" | [IEEE 754-2008 binary32](https://en.wikipedia.org/wiki/Single-precision_floating-point_format) |");
  OUT(numeric_limits<long double>::digits10);
  OUT(" | ");
  OUT(numeric_limits<long double>::max_digits10);
  OUT(" | ");
  OUT(numeric_limits<long double>::epsilon());
  OUT(" | ");
  OUT(numeric_limits<long double>::min());
  OUT(" | ");
  OUT(numeric_limits<long double>::lowest());
  OUT(" | ");
