...
int main() {
...

  {
    ...
    ECHO(using namespace literals);
    ECHO(using namespace complex_literals);
    ECHO(complex<double> z1 = 1i);
    ECHO(complex<double> z2 = 1+1i);
    ECHO(complex<double> z3 = -5i);
    ECHO(complex<double> z4 = 5);
    GMD_CODE_END();
    resultstart2("");
    resultmulti(z1);
    resultmulti(z2);
...

  {
    ...
    GMD_CODE_START("C++");
    ECHO(using namespace std);
    ECHO(const complex<double> i = complex<double>(0, 1));
    ECHO(complex<double> z1 = 1.*i);
    ECHO(complex<double> z2 = 1. + 1.*i);
    ECHO(complex<double> z3 = -5.*i);
    ECHO(complex<double> z4 = 5);
    GMD_CODE_END();
    CR();
    resultstart2("");
...

  {
    ...
    GMD_CODE_START("C++");
    ECHO(using namespace std);
    ECHO(Vector<complex<double> > v(4));
#if CPP14 == 1
    ECHO(using namespace literals);
    ECHO(using namespace complex_literals);
...

  {
    ...
    GMD_CODE_START("C++");
    ECHO(using namespace std);
    ECHO(Vector<complex<double> > v1(4));
    ECHO(Vector<complex<double> > v2(4));
#if CPP14 == 1
    ECHO(using namespace literals);
    ECHO(using namespace complex_literals);
...

  {
    ...
    GMD_CODE_START("C++");
    ECHO(using namespace std);
    ECHO(Vector<double > vr(4));
    ECHO(Vector<complex<double> > vc(4));
#if CPP14 == 1
    ECHO(using namespace literals);
    ECHO(using namespace complex_literals);
...
#else
    ECHO(v = (const complex<double>[]){ complex<double>(1,1), complex<double>(1,0), complex<double>(0,1), complex<double>(2,-5) });
#endif
    GMD_CODE_END();
    CR();
...

  {
    ...
    ECHO(using namespace std);
    ECHO(Vector<complex<double> > vc(4));
    ECHO(Vector<double> vr(range<double>(1, 4)));
    ECHO(Vector<double> vi(range<double>(-1, -4)));
    ECHO(vc = Complex(vr, vi));
    GMD_CODE_END();
    CR();
...

  {
    ...
    GMD_CODE_START("C++");
    ECHO(using namespace std);
    ECHO(Vector<double> v(range<double>(1, 4)));
    GMD_CODE_END();
    CR();
  ...
  OUTPUT("Complex cojugation can be performed via the function `conj` or via the operator `~`");
  {
    ...
    GMD_CODE_START("C++");
    ECHO(using namespace std);
    ECHO(Vector<complex<double> > vc(3));
    ECHO(Vector<double> vr(range<double>(1, 3)));
    ECHO(Vector<double> vi(range<double>(-1, 1)));
    ECHO(vc = Complex(vr, vi));
    GMD_CODE_END();
    CR();
...

  {
    ...
    ECHO(using namespace std);
    ECHO(Vector<complex<double> > v(3));
    ECHO(Vector<double> vr(range<double>(1, 3)));
    ECHO(Vector<double> vi(range<double>(-1, 1)));
    ECHO(v = Complex(vr, vi));
    GMD_CODE_END();
    CR();
