...
4.9. _Mathematical functions_ <br>
...
| ⇦ <br />[Special Vectors, Matrices, and MultiArrays](../sort-mask-slice/README.md)  | [Introduction with Examples](../README.md)<br />Mathematical functions<br /><img width=1000/> | ⇨ <br />[Special Vectors, Matrices, and MultiArrays](../multi-var-calculus/README.md)   |
| ------------ | :-------------------------------: | ------------ |
