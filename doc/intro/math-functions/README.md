[<h1 style='border: 2px solid; text-align: center'>Mathématiques 0.42.1-alpha.031</h1>](../../../README.md)
...
# 8.10. Common and Special Mathematical Functions
...
| ⇦ <br />[Indexing, Masks, Slicing, Sorting, etc.](../sort-mask-slice/README.md)  | [Introduction with Examples](../README.md)<br />Common and Special Mathematical Functions<br /><img width=1000/> | ⇨ <br />[Numerical / Discretized Mathematical Function Objects](../multi-var-calculus/README.md)   |
| ------------ | :-------------------------------: | ------------ |
