...
| ⇦ <br />[MultiArray Arithmetic](../multiarray-arithmetic/README.md)  | [Introduction with Examples](../README.md)<br />Mixed Arithmetic<br /><img width=1000/> | ⇨ <br />[Nested Arithmetic](../nested-arithmetic/README.md)   |
| ------------ | :-------------------------------: | ------------ |
