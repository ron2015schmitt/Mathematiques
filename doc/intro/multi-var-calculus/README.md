[<h1 style='border: 2px solid; text-align: center'>Mathématiques v0.41.129-c++20</h1>](../../../README.md)
...
4.10. _Mutlivariate Calculus_ <br>
...
| ⇦ <br />[Mathematical functions](../math-functions/README.md)  | [Introduction with Examples](../README.md)<br />Mutlivariate Calculus<br /><img width=1000/> | ⇨ <br />[Calculus on Complex Number Domains](../complex-calculus/README.md)   |
| ------------ | :-------------------------------: | ------------ |
