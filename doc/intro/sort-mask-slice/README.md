...
4.8. _Special Vectors, Matrices, and MultiArrays_ <br>
...
# 4.8. Special Vectors, Matrices, and MultiArrays
...
| ⇦ <br />[Linear Algebra](../linear-algebra/README.md)  | [Introduction with Examples](../README.md)<br />Special Vectors, Matrices, and MultiArrays<br /><img width=1000/> | ⇨ <br />[Mathematical functions](../math-functions/README.md)   |
| ------------ | :-------------------------------: | ------------ |
