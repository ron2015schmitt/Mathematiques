...
4.8. _Sorting, Masks, Slices, etc._ <br>
...
| ⇦ <br />[Linear Algebra](../linear-algebra/README.md)  | [Introduction with Examples](../README.md)<br />Sorting, Masks, Slices, etc.<br /><img width=1000/> | ⇨ <br />[Mathematical functions](../math-functions/README.md)   |
| ------------ | :-------------------------------: | ------------ |
