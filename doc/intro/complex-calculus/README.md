...
inside []
☀ x_[i] ➜ std::complex<double> (-20,-20);
inside []
☀ x_[i] ➜ std::complex<double> (-20,-10);
inside []
☀ x_[i] ➜ std::complex<double> (-20,0);
inside []
☀ x_[i] ➜ std::complex<double> (-20,10);
inside []
☀ x_[i] ➜ std::complex<double> (-20,20);
inside []
☀ x_[i] ➜ std::complex<double> (-10,-20);
inside []
☀ x_[i] ➜ std::complex<double> (-10,-10);
inside []
☀ x_[i] ➜ std::complex<double> (-10,0);
inside []
☀ x_[i] ➜ std::complex<double> (-10,10);
inside []
☀ x_[i] ➜ std::complex<double> (-10,20);
inside []
☀ x_[i] ➜ std::complex<double> (0,-20);
inside []
☀ x_[i] ➜ std::complex<double> (0,-10);
inside []
☀ x_[i] ➜ std::complex<double> (0,0);
inside []
☀ x_[i] ➜ std::complex<double> (0,10);
inside []
☀ x_[i] ➜ std::complex<double> (0,20);
...
☀ x ➜ Vector<std::complex<double>> ☀ parent_rdims ➜ RecursiveDimensions {5};
{(8.4112e-10,-1.88172e-09), (1.85269e-05,-4.14477e-05), (0.408082,-0.912945), (8988.61,-20109), (1.97987e+08,-4.42929e+08)};
inside []
☀ x_[i] ➜ std::complex<double> (8.4112e-10,-1.88172e-09);
inside []
☀ x_[i] ➜ std::complex<double> (1.85269e-05,-4.14477e-05);
inside []
☀ x_[i] ➜ std::complex<double> (0.408082,-0.912945);
inside []
☀ x_[i] ➜ std::complex<double> (8988.61,-20109);
inside []
☀ x_[i] ➜ std::complex<double> (1.97987e+08,-4.42929e+08);
☀ x ➜ Vector<std::complex<double>> ☀ parent_rdims ➜ RecursiveDimensions {5};
{(8.4112e-10,-1.88172e-09), (1.85269e-05,-4.14477e-05), (0.408082,-0.912945), (8988.61,-20109), (1.97987e+08,-4.42929e+08)};
inside []
☀ x_[i] ➜ std::complex<double> (8.4112e-10,-1.88172e-09);
...
☀ x_[i] ➜ std::complex<double> (1.97987e+08,-4.42929e+08);
☀ x ➜ Vector<std::complex<double>> ☀ parent_rdims ➜ RecursiveDimensions {5};
{(-1.72946e-09,1.12131e-09), (-3.80938e-05,2.46985e-05), (-0.839072,0.544021), (-18481.8,11982.9), (-4.07088e+08,2.6394e+08)};
inside []
☀ x_[i] ➜ std::complex<double> (-1.72946e-09,1.12131e-09);
inside []
☀ x_[i] ➜ std::complex<double> (-3.80938e-05,2.46985e-05);
inside []
☀ x_[i] ➜ std::complex<double> (-0.839072,0.544021);
inside []
☀ x_[i] ➜ std::complex<double> (-18481.8,11982.9);
inside []
☀ x_[i] ➜ std::complex<double> (-4.07088e+08,2.6394e+08);
☀ x ➜ Vector<std::complex<double>> ☀ parent_rdims ➜ RecursiveDimensions {5};
{(-1.72946e-09,1.12131e-09), (-3.80938e-05,2.46985e-05), (-0.839072,0.544021), (-18481.8,11982.9), (-4.07088e+08,2.6394e+08)};
inside []
☀ x_[i] ➜ std::complex<double> (-1.72946e-09,1.12131e-09);
...
☀ x_[i] ➜ std::complex<double> (-4.07088e+08,2.6394e+08);
☀ x ➜ Vector<std::complex<double>> ☀ parent_rdims ➜ RecursiveDimensions {5};
{(2.06115e-09,0), (4.53999e-05,0), (1,0), (22026.5,0), (4.85165e+08,0)};
inside []
☀ x_[i] ➜ std::complex<double> (2.06115e-09,0);
inside []
☀ x_[i] ➜ std::complex<double> (4.53999e-05,0);
inside []
☀ x_[i] ➜ std::complex<double> (1,0);
inside []
☀ x_[i] ➜ std::complex<double> (22026.5,0);
inside []
☀ x_[i] ➜ std::complex<double> (4.85165e+08,0);
☀ x ➜ Vector<std::complex<double>> ☀ parent_rdims ➜ RecursiveDimensions {5};
{(2.06115e-09,0), (4.53999e-05,0), (1,0), (22026.5,0), (4.85165e+08,0)};
inside []
☀ x_[i] ➜ std::complex<double> (2.06115e-09,0);
...
☀ *this ➜ Scalar<Matrix<std::complex<double>>> 
{

};
☀ x ➜ Scalar<Matrix<std::complex<double>>> 
{
...
☀ x.recursive_dims() ➜ RecursiveDimensions {{}, 5⨯5};
☀ data_ ➜ Matrix<std::complex<double>> 
{
...
☀ x ➜ Vector<std::complex<double>> ☀ parent_rdims ➜ RecursiveDimensions {5};
{(0.5,0.5), (0.52,0.64), (0.6,0.8), (0.764706,0.941176), (1,1)};
inside []
☀ x_[i] ➜ std::complex<double> (0.5,0.5);
inside []
☀ x_[i] ➜ std::complex<double> (0.52,0.64);
inside []
☀ x_[i] ➜ std::complex<double> (0.6,0.8);
inside []
☀ x_[i] ➜ std::complex<double> (0.764706,0.941176);
inside []
...
☀ x_[i] ➜ std::complex<double> (1,1);
☀ x ➜ Vector<std::complex<double>> ☀ parent_rdims ➜ RecursiveDimensions {5};
{(0.2,0.4), (0.0769231,0.615385), (-0,1), (0.2,1.6), (1,2)};
inside []
☀ x_[i] ➜ std::complex<double> (0.2,0.4);
inside []
☀ x_[i] ➜ std::complex<double> (0.0769231,0.615385);
inside []
☀ x_[i] ➜ std::complex<double> (-0,1);
inside []
☀ x_[i] ➜ std::complex<double> (0.2,1.6);
inside []
☀ x_[i] ➜ std::complex<double> (1,2);
☀ x ➜ Vector<std::complex<double>> ☀ parent_rdims ➜ RecursiveDimensions {5};
{(0.2,0.4), (0.0769231,0.615385), (-0,1), (0.2,1.6), (1,2)};
inside []
☀ x_[i] ➜ std::complex<double> (0.2,0.4);
...
☀ x_[i] ➜ std::complex<double> (1,2);
☀ x ➜ Vector<std::complex<double>> ☀ parent_rdims ➜ RecursiveDimensions {5};
{(-0,-0), (-0.333333,-0), (-1,-0), (-3,-0), (inf,-nan)};
inside []
☀ x_[i] ➜ std::complex<double> (-0,-0);
inside []
☀ x_[i] ➜ std::complex<double> (-0.333333,-0);
inside []
☀ x_[i] ➜ std::complex<double> (-1,-0);
inside []
☀ x_[i] ➜ std::complex<double> (-3,-0);
inside []
☀ x_[i] ➜ std::complex<double> (inf,-nan);
☀ x ➜ Vector<std::complex<double>> ☀ parent_rdims ➜ RecursiveDimensions {5};
{(-0,-0), (-0.333333,-0), (-1,-0), (-3,-0), (inf,-nan)};
inside []
☀ x_[i] ➜ std::complex<double> (-0,-0);
