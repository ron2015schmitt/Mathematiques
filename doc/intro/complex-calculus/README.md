...
4.11. _Special Vectors, Matrices, and MultiArrays_ <br>
...
# 4.11. Special Vectors, Matrices, and MultiArrays
...
| ⇦ <br />[Special Vectors, Matrices, and MultiArrays](../multi-var-calculus/README.md)  | [Introduction with Examples](../README.md)<br />Special Vectors, Matrices, and MultiArrays<br /><img width=1000/> | ⇨ <br />[Calculus and Vector Calculus](../vector-calculus/README.md)   |
| ------------ | :-------------------------------: | ------------ |
