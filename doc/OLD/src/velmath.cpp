...
int main() {
...

  {
    ...
    GMD_CODE_START("C++");
    ECHO(Vector<double> v1(4));
    codemultiNoteC11Array(v1 = { 10,20,30,40 });
    ECHO(Vector<double> v2(4));
...

  {
    ...
    GMD_CODE_START("C++");
    ECHO(double pi = std::acos(-1));
    ECHO(Vector<double> v(3));
    ECHO(Vector<double> v1(9));
    ECHO(Vector<double> v2(9));
    codemultiNoteC11Array(v = { -1,0,1 });
