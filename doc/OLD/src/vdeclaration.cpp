...
int main() {
...

  {
    ...
    GMD_CODE_START("C++");
    ECHO(Vector<double> v(4, (const double[]) { 10, 20, 30, 40 }));
    GMD_CODE_END();
    RESULT(v);
  }

  {
    ...
    GMD_CODE_START("C++");
    ECHO(Vector<double> v({ 10, 20, 30, 40 }));
    GMD_CODE_END();
    RESULT(v);
  }
