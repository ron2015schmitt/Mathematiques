...
namespace mathq {
  ...
  public:
    ...
    explicit MatrixSymmetric<Number, N>(const size_t M) {
      resize(M);
      *this = 0;
    }
    ...
    explicit MatrixSymmetric<Number, N>(const size_t M, const Number& value) {
      resize(M);
      *this = value;
    }
    ...
    MatrixSymmetric<Number, N>& resize(const int M) {
      N_ = N;
