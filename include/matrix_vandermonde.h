...
namespace mathq {
  ...
  public:
    ...
    explicit MatrixVandermonde<D, NR, NC>(const Vector<D>& v, const size_t Nc) {
    ...
    explicit MatrixVandermonde<D, NR, NC>(const size_t Nr, const size_t Nc) {
      resize(Nr, Nc);
      *this = 0;
    }
    ...
    explicit MatrixVandermonde<D, NR, NC>(const size_t Nr, const size_t Nc, const D& value) {
      resize(Nr, Nc);
      *this = value;
    }
    ...
    MatrixVandermonde<D, NR, NC>& reshape(const size_t nr, const size_t nc) {
