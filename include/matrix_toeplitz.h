...
namespace mathq {
  ...
  public:
    ...
    explicit MatrixToeplitz<D, NR, NC>(const Vector<D>& v, const size_t Nr, const size_t Nc) {
      const size_t size = v.size();
      // TODO: chekc that size = NR + NC -1
    ...
    explicit MatrixToeplitz<D, NR, NC>(const size_t Nr, const size_t Nc) {
      resize(Nr, Nc);
      *this = 0;
    }
    ...
    explicit MatrixToeplitz<D, NR, NC>(const size_t Nr, const size_t Nc, const D& value) {
      resize(Nr, Nc);
      *this = value;
    }
    ...
    MatrixToeplitz<D, NR, NC>& reshape(const size_t nr, const size_t nc) {
