...
namespace mathq {
  ...
  auto transpose(const ExpressionR<X, Element, Number, depth, rank>& x) {
    return TER_Transpose<ExpressionR<X, Element, Number, depth, rank>, Element, Number, depth, rank, FUNCTOR_pos<Element, Element, Number, Number>>(x);
  }
  ...
  auto adjoint(const ExpressionR<X, Element, std::complex<Number>, depth, rank>& x) {
    return TER_Transpose<ExpressionR<X, Element, std::complex<Number>, depth, rank>, Element, std::complex<Number>, depth, rank, FUNCTOR_conj_complex<Element, Element, std::complex<Number>, std::complex<Number>>>(x);
  }
  ...
  auto adjoint(const ExpressionR<X, Element, Imaginary<Number>, depth, rank>& x) {
    return TER_Transpose<ExpressionR<X, Element, Imaginary<Number>, depth, rank>, Element, Imaginary<Number>, depth, rank, FUNCTOR_conj_imag<Element, Element, Imaginary<Number>, Imaginary<Number>>>(x);
  }
  ...
  auto join(const ExpressionRW<A, Element, Number, depth, rank>& x1, const ExpressionRW<B, Element, Number, depth, rank>& x2) {
    ...
    return TERW_Join<ExpressionRW<A, Element, Number, depth, rank>, ExpressionRW<B, Element, Number, depth, rank>, Element, Number, depth>(a1, a2);
  }
  ...
  auto join(const ExpressionR<A, Element, Number, depth, rank>& x1, const ExpressionR<B, Element, Number, depth, rank>& x2) {
    return  TER_Join<ExpressionR<A, Element, Number, depth, rank>, ExpressionR<B, Element, Number, depth, rank>, Element, Number, depth>(x1, x2);
  }
  ...
  auto rep(const ExpressionR<A, Number, Number, 1, 1>& a, const size_t m) {
    return TER_Rep<ExpressionR<A, Number, Number, 1, 1>, Number>(a, m);
  }
