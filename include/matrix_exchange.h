...
namespace mathq {
  ...
  public:
    ...
    typename std::enable_if<is_complex<T>{}, MatrixExchange<Number, NR, NC>& >::type adjoint() {
      return *this;
    }
    ...
    MatrixExchange<Number, NR, NC>& roundzero(OrderedNumberType tolerance = Functions<OrderedNumberType>::tolerance) {
      return *this;
    }
    ...
    template< typename T = Number >
    typename std::enable_if<is_complex<T>{}, MatrixExchange<Number, NR, NC>& >::type conj() {
      return *this;
    }
