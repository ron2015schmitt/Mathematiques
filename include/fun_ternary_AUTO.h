...
auto sph_legendre(const MArrayExpR<A, E1, D1, Depth, R>& x1, const MArrayExpR<B, E2, D2, Depth, R>& x2, const MArrayExpR<C, E3, D3, Depth, R>& x3) {
...
auto sph_legendre(const MArrayExpR<A, E1, D1, Depth, R>& x1, const MArrayExpR<B, E2, D2, Depth, R>& x2, const D3& x3) {
  typedef typename MultType<typename MultType<D1, D2>::Type, D3>::Type D4;
  typedef typename NumberTrait<E1, D4>::ReplaceTypeD E4;   // see TODO note above
  return  TER_Ternary<MArrayExpR<A, E1, D1, Depth, R>,
    MArrayExpR<B, E2, D2, Depth, R>,
...
auto sph_legendre(const MArrayExpR<A, E1, D1, Depth, R>& x1, const D2& x2, const MArrayExpR<C, E3, D3, Depth, R>& x3) {
  typedef typename MultType<typename MultType<D1, D2>::Type, D3>::Type D4;
  typedef typename NumberTrait<E1, D4>::ReplaceTypeD E4;   // see TODO note above
  return  TER_Ternary<MArrayExpR<A, E1, D1, Depth, R>,
    D2,
...
auto sph_legendre(const MArrayExpR<A, E1, D1, Depth, R>& x1, const D2& x2, const D3& x3) {
  typedef typename MultType<typename MultType<D1, D2>::Type, D3>::Type D4;
  typedef typename NumberTrait<E1, D4>::ReplaceTypeD E4;   // see TODO note above
  return  TER_Ternary<MArrayExpR<A, E1, D1, Depth, R>,
    D2,
...
auto sph_legendre(const D1& x1, const MArrayExpR<B, E2, D2, Depth, R>& x2, const MArrayExpR<C, E3, D3, Depth, R>& x3) {
  typedef typename MultType<typename MultType<D1, D2>::Type, D3>::Type D4;
...
auto sph_legendre(const D1& x1, const MArrayExpR<B, E2, D2, Depth, R>& x2, const D3& x3) {
  typedef typename MultType<typename MultType<D1, D2>::Type, D3>::Type D4;
  typedef typename NumberTrait<E2, D4>::ReplaceTypeD E4;   // see TODO note above
  return  TER_Ternary<D1,
    MArrayExpR<B, E2, D2, Depth, R>,
...
auto sph_legendre(const D1& x1, const D2& x2, const MArrayExpR<C, E3, D3, Depth, R>& x3) {
  typedef typename MultType<typename MultType<D1, D2>::Type, D3>::Type D4;
...
template <class A, class B, class C, class E1, class E2, class E3, class D1, class D2, class D3, int Depth, int R>
auto assoc_legendre(const MArrayExpR<A, E1, D1, Depth, R>& x1, const MArrayExpR<B, E2, D2, Depth, R>& x2, const MArrayExpR<C, E3, D3, Depth, R>& x3) {
  typedef typename MultType<typename MultType<D1, D2>::Type, D3>::Type D4;
  typedef typename NumberTrait<E1, D4>::ReplaceTypeD E4;   // see TODO note above
  return  TER_Ternary<MArrayExpR<A, E1, D1, Depth, R>,
    MArrayExpR<B, E2, D2, Depth, R>,
...
template <class A, class B, class E1, class E2, class D1, class D2, class D3, int Depth, int R, typename = std::enable_if_t<NumberTrait<D3>::value>>
auto assoc_legendre(const MArrayExpR<A, E1, D1, Depth, R>& x1, const MArrayExpR<B, E2, D2, Depth, R>& x2, const D3& x3) {
  typedef typename MultType<typename MultType<D1, D2>::Type, D3>::Type D4;
  typedef typename NumberTrait<E1, D4>::ReplaceTypeD E4;   // see TODO note above
  return  TER_Ternary<MArrayExpR<A, E1, D1, Depth, R>,
    MArrayExpR<B, E2, D2, Depth, R>,
...
template <class A, class C, class E1, class E3, class D1, class D2, class D3, int Depth, int R, typename = std::enable_if_t<NumberTrait<D2>::value>>
auto assoc_legendre(const MArrayExpR<A, E1, D1, Depth, R>& x1, const D2& x2, const MArrayExpR<C, E3, D3, Depth, R>& x3) {
  typedef typename MultType<typename MultType<D1, D2>::Type, D3>::Type D4;
  typedef typename NumberTrait<E1, D4>::ReplaceTypeD E4;   // see TODO note above
  return  TER_Ternary<MArrayExpR<A, E1, D1, Depth, R>,
    D2,
...
template <class A, class E1, class D1, class D2, class D3, int Depth, int R, typename = std::enable_if_t<NumberTrait<D2>::value&& NumberTrait<D3>::value>>
auto assoc_legendre(const MArrayExpR<A, E1, D1, Depth, R>& x1, const D2& x2, const D3& x3) {
  typedef typename MultType<typename MultType<D1, D2>::Type, D3>::Type D4;
  typedef typename NumberTrait<E1, D4>::ReplaceTypeD E4;   // see TODO note above
  return  TER_Ternary<MArrayExpR<A, E1, D1, Depth, R>,
    D2,
...
template <class B, class C, class E2, class E3, class D1, class D2, class D3, int Depth, int R, typename = std::enable_if_t<NumberTrait<D1>::value>>
auto assoc_legendre(const D1& x1, const MArrayExpR<B, E2, D2, Depth, R>& x2, const MArrayExpR<C, E3, D3, Depth, R>& x3) {
  typedef typename MultType<typename MultType<D1, D2>::Type, D3>::Type D4;
  typedef typename NumberTrait<E2, D4>::ReplaceTypeD E4;   // see TODO note above
  return  TER_Ternary<D1,
    MArrayExpR<B, E2, D2, Depth, R>,
...
template <class B, class E2, class D1, class D2, class D3, int Depth, int R, typename = std::enable_if_t<NumberTrait<D1>::value&& NumberTrait<D3>::value>>
auto assoc_legendre(const D1& x1, const MArrayExpR<B, E2, D2, Depth, R>& x2, const D3& x3) {
  typedef typename MultType<typename MultType<D1, D2>::Type, D3>::Type D4;
  typedef typename NumberTrait<E2, D4>::ReplaceTypeD E4;   // see TODO note above
  return  TER_Ternary<D1,
    MArrayExpR<B, E2, D2, Depth, R>,
...
template <class C, class E3, class D1, class D2, class D3, int Depth, int R, typename = std::enable_if_t<NumberTrait<D1>::value&& NumberTrait<D2>::value>>
auto assoc_legendre(const D1& x1, const D2& x2, const MArrayExpR<C, E3, D3, Depth, R>& x3) {
  typedef typename MultType<typename MultType<D1, D2>::Type, D3>::Type D4;
  typedef typename NumberTrait<E3, D4>::ReplaceTypeD E4;   // see TODO note above
  return  TER_Ternary<D1,
    D2,
...
template <class A, class B, class C, class E1, class E2, class E3, class D1, class D2, class D3, int Depth, int R>
auto assoc_laguerre(const MArrayExpR<A, E1, D1, Depth, R>& x1, const MArrayExpR<B, E2, D2, Depth, R>& x2, const MArrayExpR<C, E3, D3, Depth, R>& x3) {
  typedef typename MultType<typename MultType<D1, D2>::Type, D3>::Type D4;
  typedef typename NumberTrait<E1, D4>::ReplaceTypeD E4;   // see TODO note above
  return  TER_Ternary<MArrayExpR<A, E1, D1, Depth, R>,
    MArrayExpR<B, E2, D2, Depth, R>,
...
template <class A, class B, class E1, class E2, class D1, class D2, class D3, int Depth, int R, typename = std::enable_if_t<NumberTrait<D3>::value>>
auto assoc_laguerre(const MArrayExpR<A, E1, D1, Depth, R>& x1, const MArrayExpR<B, E2, D2, Depth, R>& x2, const D3& x3) {
  typedef typename MultType<typename MultType<D1, D2>::Type, D3>::Type D4;
  typedef typename NumberTrait<E1, D4>::ReplaceTypeD E4;   // see TODO note above
  return  TER_Ternary<MArrayExpR<A, E1, D1, Depth, R>,
    MArrayExpR<B, E2, D2, Depth, R>,
...
template <class A, class C, class E1, class E3, class D1, class D2, class D3, int Depth, int R, typename = std::enable_if_t<NumberTrait<D2>::value>>
auto assoc_laguerre(const MArrayExpR<A, E1, D1, Depth, R>& x1, const D2& x2, const MArrayExpR<C, E3, D3, Depth, R>& x3) {
  typedef typename MultType<typename MultType<D1, D2>::Type, D3>::Type D4;
  typedef typename NumberTrait<E1, D4>::ReplaceTypeD E4;   // see TODO note above
  return  TER_Ternary<MArrayExpR<A, E1, D1, Depth, R>,
    D2,
...
template <class A, class E1, class D1, class D2, class D3, int Depth, int R, typename = std::enable_if_t<NumberTrait<D2>::value&& NumberTrait<D3>::value>>
auto assoc_laguerre(const MArrayExpR<A, E1, D1, Depth, R>& x1, const D2& x2, const D3& x3) {
  typedef typename MultType<typename MultType<D1, D2>::Type, D3>::Type D4;
  typedef typename NumberTrait<E1, D4>::ReplaceTypeD E4;   // see TODO note above
  return  TER_Ternary<MArrayExpR<A, E1, D1, Depth, R>,
    D2,
...
template <class B, class C, class E2, class E3, class D1, class D2, class D3, int Depth, int R, typename = std::enable_if_t<NumberTrait<D1>::value>>
auto assoc_laguerre(const D1& x1, const MArrayExpR<B, E2, D2, Depth, R>& x2, const MArrayExpR<C, E3, D3, Depth, R>& x3) {
  typedef typename MultType<typename MultType<D1, D2>::Type, D3>::Type D4;
  typedef typename NumberTrait<E2, D4>::ReplaceTypeD E4;   // see TODO note above
  return  TER_Ternary<D1,
    MArrayExpR<B, E2, D2, Depth, R>,
...
template <class B, class E2, class D1, class D2, class D3, int Depth, int R, typename = std::enable_if_t<NumberTrait<D1>::value&& NumberTrait<D3>::value>>
auto assoc_laguerre(const D1& x1, const MArrayExpR<B, E2, D2, Depth, R>& x2, const D3& x3) {
  typedef typename MultType<typename MultType<D1, D2>::Type, D3>::Type D4;
  typedef typename NumberTrait<E2, D4>::ReplaceTypeD E4;   // see TODO note above
  return  TER_Ternary<D1,
    MArrayExpR<B, E2, D2, Depth, R>,
...
template <class C, class E3, class D1, class D2, class D3, int Depth, int R, typename = std::enable_if_t<NumberTrait<D1>::value&& NumberTrait<D2>::value>>
auto assoc_laguerre(const D1& x1, const D2& x2, const MArrayExpR<C, E3, D3, Depth, R>& x3) {
  typedef typename MultType<typename MultType<D1, D2>::Type, D3>::Type D4;
  typedef typename NumberTrait<E3, D4>::ReplaceTypeD E4;   // see TODO note above
  return  TER_Ternary<D1,
    D2,
...
template <class A, class B, class C, class E1, class E2, class E3, class D1, class D2, class D3, int Depth, int R>
auto ellint_3(const MArrayExpR<A, E1, D1, Depth, R>& x1, const MArrayExpR<B, E2, D2, Depth, R>& x2, const MArrayExpR<C, E3, D3, Depth, R>& x3) {
  typedef typename MultType<typename MultType<D1, D2>::Type, D3>::Type D4;
  typedef typename NumberTrait<E1, D4>::ReplaceTypeD E4;   // see TODO note above
  return  TER_Ternary<MArrayExpR<A, E1, D1, Depth, R>,
    MArrayExpR<B, E2, D2, Depth, R>,
...
template <class A, class B, class E1, class E2, class D1, class D2, class D3, int Depth, int R, typename = std::enable_if_t<NumberTrait<D3>::value>>
auto ellint_3(const MArrayExpR<A, E1, D1, Depth, R>& x1, const MArrayExpR<B, E2, D2, Depth, R>& x2, const D3& x3) {
  typedef typename MultType<typename MultType<D1, D2>::Type, D3>::Type D4;
  typedef typename NumberTrait<E1, D4>::ReplaceTypeD E4;   // see TODO note above
  return  TER_Ternary<MArrayExpR<A, E1, D1, Depth, R>,
    MArrayExpR<B, E2, D2, Depth, R>,
...
template <class A, class C, class E1, class E3, class D1, class D2, class D3, int Depth, int R, typename = std::enable_if_t<NumberTrait<D2>::value>>
auto ellint_3(const MArrayExpR<A, E1, D1, Depth, R>& x1, const D2& x2, const MArrayExpR<C, E3, D3, Depth, R>& x3) {
  typedef typename MultType<typename MultType<D1, D2>::Type, D3>::Type D4;
  typedef typename NumberTrait<E1, D4>::ReplaceTypeD E4;   // see TODO note above
  return  TER_Ternary<MArrayExpR<A, E1, D1, Depth, R>,
    D2,
...
template <class A, class E1, class D1, class D2, class D3, int Depth, int R, typename = std::enable_if_t<NumberTrait<D2>::value&& NumberTrait<D3>::value>>
auto ellint_3(const MArrayExpR<A, E1, D1, Depth, R>& x1, const D2& x2, const D3& x3) {
  typedef typename MultType<typename MultType<D1, D2>::Type, D3>::Type D4;
  typedef typename NumberTrait<E1, D4>::ReplaceTypeD E4;   // see TODO note above
  return  TER_Ternary<MArrayExpR<A, E1, D1, Depth, R>,
    D2,
...
template <class B, class C, class E2, class E3, class D1, class D2, class D3, int Depth, int R, typename = std::enable_if_t<NumberTrait<D1>::value>>
auto ellint_3(const D1& x1, const MArrayExpR<B, E2, D2, Depth, R>& x2, const MArrayExpR<C, E3, D3, Depth, R>& x3) {
  typedef typename MultType<typename MultType<D1, D2>::Type, D3>::Type D4;
  typedef typename NumberTrait<E2, D4>::ReplaceTypeD E4;   // see TODO note above
  return  TER_Ternary<D1,
    MArrayExpR<B, E2, D2, Depth, R>,
...
template <class B, class E2, class D1, class D2, class D3, int Depth, int R, typename = std::enable_if_t<NumberTrait<D1>::value&& NumberTrait<D3>::value>>
auto ellint_3(const D1& x1, const MArrayExpR<B, E2, D2, Depth, R>& x2, const D3& x3) {
  typedef typename MultType<typename MultType<D1, D2>::Type, D3>::Type D4;
  typedef typename NumberTrait<E2, D4>::ReplaceTypeD E4;   // see TODO note above
  return  TER_Ternary<D1,
    MArrayExpR<B, E2, D2, Depth, R>,
...
template <class C, class E3, class D1, class D2, class D3, int Depth, int R, typename = std::enable_if_t<NumberTrait<D1>::value&& NumberTrait<D2>::value>>
auto ellint_3(const D1& x1, const D2& x2, const MArrayExpR<C, E3, D3, Depth, R>& x3) {
  typedef typename MultType<typename MultType<D1, D2>::Type, D3>::Type D4;
  typedef typename NumberTrait<E3, D4>::ReplaceTypeD E4;   // see TODO note above
  return  TER_Ternary<D1,
    D2,
...
template <class A, class B, class C, class E1, class E2, class E3, class D1, class D2, class D3, int Depth, int R>
auto comp_ellint_3(const MArrayExpR<A, E1, D1, Depth, R>& x1, const MArrayExpR<B, E2, D2, Depth, R>& x2, const MArrayExpR<C, E3, D3, Depth, R>& x3) {
  typedef typename MultType<typename MultType<D1, D2>::Type, D3>::Type D4;
  typedef typename NumberTrait<E1, D4>::ReplaceTypeD E4;   // see TODO note above
  return  TER_Ternary<MArrayExpR<A, E1, D1, Depth, R>,
    MArrayExpR<B, E2, D2, Depth, R>,
...
template <class A, class B, class E1, class E2, class D1, class D2, class D3, int Depth, int R, typename = std::enable_if_t<NumberTrait<D3>::value>>
auto comp_ellint_3(const MArrayExpR<A, E1, D1, Depth, R>& x1, const MArrayExpR<B, E2, D2, Depth, R>& x2, const D3& x3) {
  typedef typename MultType<typename MultType<D1, D2>::Type, D3>::Type D4;
  typedef typename NumberTrait<E1, D4>::ReplaceTypeD E4;   // see TODO note above
  return  TER_Ternary<MArrayExpR<A, E1, D1, Depth, R>,
    MArrayExpR<B, E2, D2, Depth, R>,
...
template <class A, class C, class E1, class E3, class D1, class D2, class D3, int Depth, int R, typename = std::enable_if_t<NumberTrait<D2>::value>>
auto comp_ellint_3(const MArrayExpR<A, E1, D1, Depth, R>& x1, const D2& x2, const MArrayExpR<C, E3, D3, Depth, R>& x3) {
  typedef typename MultType<typename MultType<D1, D2>::Type, D3>::Type D4;
  typedef typename NumberTrait<E1, D4>::ReplaceTypeD E4;   // see TODO note above
  return  TER_Ternary<MArrayExpR<A, E1, D1, Depth, R>,
    D2,
...
template <class A, class E1, class D1, class D2, class D3, int Depth, int R, typename = std::enable_if_t<NumberTrait<D2>::value&& NumberTrait<D3>::value>>
auto comp_ellint_3(const MArrayExpR<A, E1, D1, Depth, R>& x1, const D2& x2, const D3& x3) {
  typedef typename MultType<typename MultType<D1, D2>::Type, D3>::Type D4;
  typedef typename NumberTrait<E1, D4>::ReplaceTypeD E4;   // see TODO note above
  return  TER_Ternary<MArrayExpR<A, E1, D1, Depth, R>,
    D2,
...
template <class B, class C, class E2, class E3, class D1, class D2, class D3, int Depth, int R, typename = std::enable_if_t<NumberTrait<D1>::value>>
auto comp_ellint_3(const D1& x1, const MArrayExpR<B, E2, D2, Depth, R>& x2, const MArrayExpR<C, E3, D3, Depth, R>& x3) {
  typedef typename MultType<typename MultType<D1, D2>::Type, D3>::Type D4;
  typedef typename NumberTrait<E2, D4>::ReplaceTypeD E4;   // see TODO note above
  return  TER_Ternary<D1,
    MArrayExpR<B, E2, D2, Depth, R>,
...
template <class B, class E2, class D1, class D2, class D3, int Depth, int R, typename = std::enable_if_t<NumberTrait<D1>::value&& NumberTrait<D3>::value>>
auto comp_ellint_3(const D1& x1, const MArrayExpR<B, E2, D2, Depth, R>& x2, const D3& x3) {
  typedef typename MultType<typename MultType<D1, D2>::Type, D3>::Type D4;
  typedef typename NumberTrait<E2, D4>::ReplaceTypeD E4;   // see TODO note above
  return  TER_Ternary<D1,
    MArrayExpR<B, E2, D2, Depth, R>,
...
template <class C, class E3, class D1, class D2, class D3, int Depth, int R, typename = std::enable_if_t<NumberTrait<D1>::value&& NumberTrait<D2>::value>>
auto comp_ellint_3(const D1& x1, const D2& x2, const MArrayExpR<C, E3, D3, Depth, R>& x3) {
  typedef typename MultType<typename MultType<D1, D2>::Type, D3>::Type D4;
  typedef typename NumberTrait<E3, D4>::ReplaceTypeD E4;   // see TODO note above
  return  TER_Ternary<D1,
    D2,
