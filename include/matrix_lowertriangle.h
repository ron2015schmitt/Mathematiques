...
namespace mathq {
  ...
  public:
    ...
    typename std::enable_if<is_complex<T>{}, MatrixLowerTriangle<Number, N>& >::type adjoint() {
      return *this;
    }
    ...
    template< typename T = Number >
    typename std::enable_if<is_complex<T>{}, MatrixLowerTriangle<Number, N>& >::type conj() {
      return *this;
    }
